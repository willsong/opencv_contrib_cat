...
int main(int argc, char** argv)
{
    ...
    cout << endl << "Success: " << success << ", fails: " << fails << ", success rate: " << ((double)success / images.size() * 100) << "%" << endl;
}
...
bool myDetector(InputArray image, OutputArray faces, CascadeClassifier *face_cascade)
{
    ...
    face_cascade->detectMultiScale(gray, faces_, 1.4, 2, CASCADE_SCALE_IMAGE, Size(10, 10));
    //if (faces_.size() > 0)
    //{
